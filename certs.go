...
// This function removes existing colons and spaces, converts to lowercase,
// adds a leading zero if needed, and formats with colons separating each pair of hex digits.
