...
func (_m *MockService) CreateCSR(ctx context.Context, metadata certs.CSRMetadata, privKey *rsa.PrivateKey) (certs.CSR, error) {
	...
	var r0 certs.CSR
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, certs.CSRMetadata, *rsa.PrivateKey) (certs.CSR, error)); ok {
		return rf(ctx, metadata, privKey)
	}
	if rf, ok := ret.Get(0).(func(context.Context, certs.CSRMetadata, *rsa.PrivateKey) certs.CSR); ok {
		r0 = rf(ctx, metadata, privKey)
	} else {
		r0 = ret.Get(0).(certs.CSR)
	}

	if rf, ok := ret.Get(1).(func(context.Context, certs.CSRMetadata, *rsa.PrivateKey) error); ok {
...
func (_c *MockService_CreateCSR_Call) Run(run func(ctx context.Context, metadata certs.CSRMetadata, privKey *rsa.PrivateKey)) *MockService_CreateCSR_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(certs.CSRMetadata), args[2].(*rsa.PrivateKey))
	})
	return _c
}
...
func (_c *MockService_CreateCSR_Call) RunAndReturn(run func(context.Context, certs.CSRMetadata, *rsa.PrivateKey) (certs.CSR, error)) *MockService_CreateCSR_Call {
	_c.Call.Return(run)
	return _c
}
