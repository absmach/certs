...
func (_m *MockService) IssueCert(ctx context.Context, entityID string, entityType certs.EntityType, ipAddrs []string) (string, error) {
...
//   - ipAddrs []string
func (_e *MockService_Expecter) IssueCert(ctx interface{}, entityID interface{}, entityType interface{}, ipAddrs interface{}) *MockService_IssueCert_Call {
	return &MockService_IssueCert_Call{Call: _e.mock.On("IssueCert", ctx, entityID, entityType, ipAddrs)}
}

func (_c *MockService_IssueCert_Call) Run(run func(ctx context.Context, entityID string, entityType certs.EntityType, ipAddrs []string)) *MockService_IssueCert_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(string), args[2].(certs.EntityType), args[3].([]string))
	})
	return _c
}
...
func (_c *MockService_IssueCert_Call) RunAndReturn(run func(context.Context, string, certs.EntityType, []string) (string, error)) *MockService_IssueCert_Call {
	_c.Call.Return(run)
	return _c
}
